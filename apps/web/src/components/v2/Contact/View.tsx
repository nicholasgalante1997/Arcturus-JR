...
const SOCIAL_LINKS: SocialLinkItem[] = [
  {
    ...
    icon: <GitHubIcon />,
    username: 'nicholasgalante1997'
  },
  {
    name: 'GitHub',
    url: 'https://github.com/mega-blastoise',
    icon: <GitHubIcon />,
    username: 'mega-blastoise'
  },
  {
    name: 'LinkedIn',
    url: 'https://www.linkedin.com/in/nicholas-g-1963041a2/',
    icon: <LinkedInIcon />,
    username: 'nicholas-g-1963041a2'
  }
];
      ...
      <div className="v2-container">
        ...
        <header className="v2-contact-page__header">
          ...
          <p className="v2-contact-page__description">
            For all inquiries, please lead with your favorite line from the 1980 movie &apos;Airplane!&apos;.
          </p>
        </header>
