...
const TIMELINE: TimelineItem[] = [
  ...
  },
  {
    ...
    description:
      "Developed event-driven architecture for telecom service automation at CenturyLink.",
  },
  {
    year: "2020",
    ...
    description:
      "Architected serverless mobile app with AWS AppSync, Lambda, and SageMaker.",
  },
];
