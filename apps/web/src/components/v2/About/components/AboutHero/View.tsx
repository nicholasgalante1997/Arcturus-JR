      ...
      <div className="v2-about-hero__content">
        ...
        <div className="v2-about-hero__text">
          ...
          <p className="v2-about-hero__bio">
            I architect distributed systems, build developer tooling, and create
            performant web experiences. Currently at Charter Communications,
            previously Amazon Games. Passionate about Rust, React, Bun, micro-frontends, and
